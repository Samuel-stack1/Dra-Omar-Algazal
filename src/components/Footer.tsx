        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="col-span-1">
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/dr.omaralgazal" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-neutral-gray/30 flex items-center justify-center text-light-gray hover:bg-accent hover:border-accent hover:text-white transition-all">
