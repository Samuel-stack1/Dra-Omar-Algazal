    ...
    <footer className="relative bg-secondary-dark text-white pt-20 pb-10 overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          {/* Social */}
          <div className="col-span-1">
            <h4 className="font-heading font-semibold text-lg mb-6">Redes Sociais</h4>
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 rounded-full border border-neutral-gray/30 flex items-center justify-center text-light-gray hover:bg-accent hover:border-accent hover:text-white transition-all">
